...
<template>
  <section class="bg-transparent">
    <div class="py-8 mx-auto max-w-6xl lg:py-16">
      <div
        class="grid gap-4 px-4 mb-4 sm:mb-5 sm:grid-cols-3 sm:gap-6 md:gap-12"
      >
        <!-- Column -->
        <div class="sm:col-span-2">
          <div class="flex items-center space-x-4">
            <BaseAvatar :avatar-size="8" :avatar="`https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/helene-engels.png`" />
            <div>
              <h2
          ...
          <dl>
            ...
            >
              Творим и воплощаем любые Ваши задумки
            </dd>
            <dt
              class="mb-2 font-semibold leading-none text-gray-900 dark:text-white"
            >
            ...
            <dd class="inline-flex items-center mb-4 space-x-1 sm:mb-5">
              <a
                ...
                class="p-2 text-gray-500 rounded-lg hover:text-gray-900 dark:text-gray-400 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
              >
                <svg
                  class="w-6 h-5"
                  fill="currentColor"
            ...
            <dd
              class="flex items-center mb-4 text-gray-900 sm:mb-5 dark:text-white"
            >
              <svg
        ...
        <dl>
          ...
          <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">
            143026, Московская область, Большой бульвар, д. 46, строение 1
          </dd>
          <dt
            class="mb-2 font-semibold leading-none text-gray-900 dark:text-white"
          >
          ...
          <dt
            class="font-semibold leading-none text-gray-900 dark:text-white mb-2.5"
          >
            Software Skills
          </dt>
