<script setup>
const teamData = await useFetch("/api/team/data/");

console.log(teamRef.value);
</script>
<template>
      ...
      <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
        ...
        >
          ...
          <div class="p-5">
            ...
            >
            <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">
              Кирилл - опытный фулстек разработчик, способен решать сложные
              задачи и обеспечивать высокое качество разработки.
            </p>
            <ul class="flex space-x-4 sm:mt-0">
              <li>
                <a
        ...
        >
          <a href="#">
            <img
              class="w-full rounded-lg sm:rounded-none sm:rounded-l-lg"
              src="https://webmotus.ru/wp-content/uploads/2023/11/AlexsanderKovalev.jpg"
              alt="Avatar"
            />
          </a>
          <div class="p-5">
            ...
            <span class="text-gray-500 dark:text-gray-400">Web Developer</span>
            <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">
              Александр имеет большой опыт в проработке бизнес-решений,
              улучшающие эффективность всех бизнес-процессов.
            </p>
            <ul class="flex space-x-4 sm:mt-0">
              <li>
                <a
